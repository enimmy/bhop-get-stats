...
static ConVar g_hOverrideShowkeys;
...
void Commands_Start()
{
	...
	g_hOverrideShowkeys = CreateConVar("js-override-showkeys", "1", "Override /showkeys command? (false) or 1 (true)");
...
{
	if(g_hOverrideShowkeys.IntValue)
	{
		if(BgsShavitLoaded())
		{
